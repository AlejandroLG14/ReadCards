package com.alejandrolg.readcards;
        ...
        if (requestCode == MY_SCAN_REQUEST_CODE) {
            ...
            if (data != null && data.hasExtra(CardIOActivity.EXTRA_SCAN_RESULT)) {
                ...
                if (scanResult.isExpiryValid()) {
                    ...
                    expiry.setText("Expiration Date: " + scanResult.expiryMonth + "/" + scanResult.expiryYear + "\n");
                ...
                if (scanResult.postalCode != null) {
                    ...
                    cp.setText("Postal Code: " + scanResult.postalCode + "\n");
                }
            }
            else {
